...
//  int weatherLocationTmp = EEPROM.read(Weather_Location);
//  
//  if (int(cityID) != weatherLocationTmp) {
//    EEPROM.write(Weather_Location, cityID);
//    Serial.print("write eeprom weather location : "); Serial.println(cityID);
//  }
  ...
  if (waterAutoTimerWork != waterAutoTimerWorkTmp) {
    ...
    Serial.print("eeprom write auto water timer work : "); Serial.println(waterAutoTimerWork);
  }
...
//    char cityID = EEPROM.read(Weather_Location);
    ...
    EEPROM.write(TIMER8_ADDRESS, 0);
    EEPROM.write(Weather_Location,1609350);
    EEPROM.commit();
